...
const perspectivesData = [
  {
    ...
    description: "Assesses the clarity of digital strategy and leadership's commitment to digitalization.",
  },
  {
    title: "Processes & Operations",
    description: "Evaluates the digitalization of core business processes and operational efficiency.",
  },
  {
    title: "Customer & Market",
    description: "Examines digital channels for customer engagement, market reach, and service delivery.",
  },
  {
    title: "Technology & Infrastructure",
    description: "Reviews the current IT infrastructure, systems, and technological capabilities.",
  },
  {
    title: "Data & Analytics",
    description: "Focuses on data collection, analysis, and utilization for decision-making.",
  },
  {
    title: "Workforce & Culture",
    description: "Assesses the digital skills of the workforce and the organizational culture's adaptability to digital change.",
  },
  {
    title: "Innovation & Ecosystem",
    description: "Looks at the organization's capacity for digital innovation and collaboration within its ecosystem.",
  },
  {
    title: "Security & Compliance",
    description: "Evaluates the measures in place for digital security, data protection, and regulatory compliance.",
  },
];
...
const DigitalGapAssessmentPage: React.FC = () => {
  ...
  const { mutate: submitForm, isPending, isSuccess, data } = useSubmitAssessment();
    ...
    setAssessmentInputs(prevInputs =>
      prevInputs.map(input =>
        input.perspective === perspectiveTitle
          ? { ...input, currentLevel: current, toBeLevel: tobe, comment: comment }
          : input
      )
    );
  };

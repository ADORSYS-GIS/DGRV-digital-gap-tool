...
export function OrgAdminConsolidatedReportPage() {
  ...
  const fetchReport = async () => {
    ...
    try {
      ...
      setError(null);
      const data =
        await consolidatedReportRepository.getOrgAdminConsolidatedReport(
          organizationId,
        );
      setReport(data);
    } catch (err) {
...
export default OrgAdminConsolidatedReportPage;

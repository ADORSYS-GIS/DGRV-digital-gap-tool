          ...
          >
            {selectedValues.length > 0 ? (
              <div className="flex w-full items-center justify-between">
                <div className="flex flex-wrap items-center">
                  {selectedValues.slice(0, maxCount).map((value) => {
                    ...
                    return (
                      <Badge
                        ...
                        style={{
                          animation: `scaleIn ${animation}ms ease-in-out`,
                        }}
                      >
                        {IconComponent && (
                  ...
                  {selectedValues.length > maxCount && (
                    <Badge
                      className={cn(
                        "border-foreground/10 bg-transparent text-foreground hover:bg-card/80",
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Separator
                    ...
                    className="mx-2 h-4 bg-slate-500/50"
                  />
              ...
              <div className="mx-auto flex w-full items-center justify-between">
                ...
                <ChevronDown className="mx-4 h-4 w-4 cursor-pointer text-muted-foreground" />
              </div>
            )}
          </Button>
        </PopoverTrigger>

...
export default function OnboardingCompletion({
  ...
  return (
    <div
      className={`bg-white rounded-3xl shadow-2xl p-12 text-center transition-all duration-500 ease-in-out ${isTransitioning

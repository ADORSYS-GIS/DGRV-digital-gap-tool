        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(
                        ColumnDef::new(Dimensions::DimensionId)
                            .uuid()
                            .not_null()
                            .primary_key(),
                    )
                    .col(
                        ColumnDef::new(Dimensions::Name)
                            .string()
                            .not_null()
                            .unique_key(),
                    )
                    ...
                    .col(
                        ColumnDef::new(Dimensions::CreatedAt)
                            .timestamp()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .col(
                        ColumnDef::new(Dimensions::UpdatedAt)
                            .timestamp()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(
                        ColumnDef::new(CurrentStates::CurrentStateId)
                            .uuid()
                            .not_null()
                            .primary_key(),
                    )
                    ...
                    .col(
                        ColumnDef::new(CurrentStates::UpdatedAt)
                            .timestamp()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(
                        ColumnDef::new(DesiredStates::DesiredStateId)
                            .uuid()
                            .not_null()
                            .primary_key(),
                    )
                    ...
                    .col(
                        ColumnDef::new(DesiredStates::UpdatedAt)
                            .timestamp()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(Assessments::OrganizationId)
                            .string()
                            .not_null(),
                    )
                    .col(
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(
                        ColumnDef::new(DimensionAssessments::DimensionAssessmentId)
                            .uuid()
                            .not_null()
                            .primary_key(),
                    )
                    .col(
                        ColumnDef::new(DimensionAssessments::AssessmentId)
                            .uuid()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(DimensionAssessments::DimensionId)
                            .uuid()
                            .not_null(),
                    )
                    .col(
                    ...
                    .col(
                        ColumnDef::new(DimensionAssessments::CreatedAt)
                            .timestamp()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .col(
                        ColumnDef::new(DimensionAssessments::UpdatedAt)
                            .timestamp()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(Gaps::CalculatedAt)
                            .timestamp_with_time_zone()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .col(
                        ColumnDef::new(Gaps::CreatedAt)
                            .timestamp_with_time_zone()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .col(
                        ColumnDef::new(Gaps::UpdatedAt)
                            .timestamp_with_time_zone()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(
                        ColumnDef::new(Recommendations::RecommendationId)
                            .uuid()
                            .not_null()
                            .primary_key(),
                    )
                    .col(
                        ColumnDef::new(Recommendations::DimensionId)
                            .uuid()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(Recommendations::GapSeverity)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(Recommendations::Priority)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(Recommendations::Description)
                            .text()
                            .not_null(),
                    )
                    .col(
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(
                        ColumnDef::new(AssessmentRecommendations::AssessmentRecommendationId)
                            .uuid()
                            .not_null()
                            .primary_key(),
                    )
                    .col(
                        ColumnDef::new(AssessmentRecommendations::AssessmentId)
                            .uuid()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(AssessmentRecommendations::RecommendationId)
                            .uuid()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(AssessmentRecommendations::GapValue)
                            .integer()
                            .not_null(),
                    )
                    .col(ColumnDef::new(AssessmentRecommendations::CustomNotes).text())
                    .col(
                        ColumnDef::new(AssessmentRecommendations::ImplementationStatus)
                            .string()
                            .not_null()
                            .default("planned"),
                    )
                    ...
                    .col(
                        ColumnDef::new(AssessmentRecommendations::CreatedAt)
                            .timestamp()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .col(
                        ColumnDef::new(AssessmentRecommendations::UpdatedAt)
                            .timestamp()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
            ...
            .create_foreign_key(
                ForeignKey::create()
                    ...
                    .from(
                        ...
                        DimensionAssessments::AssessmentId,
                    )
                    .to(Assessments::Table, Assessments::AssessmentId)
                    .on_delete(ForeignKeyAction::Cascade)
                    .on_update(ForeignKeyAction::Cascade)
        ...
        manager
            .create_foreign_key(
                ForeignKey::create()
                    ...
                    .from(
                        AssessmentRecommendations::Table,
                        AssessmentRecommendations::AssessmentId,
                    )
                    .to(Assessments::Table, Assessments::AssessmentId)
                    .on_delete(ForeignKeyAction::Cascade)
                    .on_update(ForeignKeyAction::Cascade)
        ...
        manager
            .create_foreign_key(
                ForeignKey::create()
                    ...
                    .from(
                        AssessmentRecommendations::Table,
                        AssessmentRecommendations::RecommendationId,
                    )

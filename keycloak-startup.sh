...
bash "$SCRIPT_DIR/keycloak-provisioning.sh" --wait-only || true
bash "$SCRIPT_DIR/keycloak-provisioning.sh" || true
...
# Wait for readiness and run provisioning
"$SCRIPT_DIR/keycloak-provisioning.sh" --wait-only || true
"$SCRIPT_DIR/keycloak-provisioning.sh" || true

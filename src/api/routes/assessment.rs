...
use crate::api::handlers::assessment::{
    ...
    update_assessment,
    delete_assessment,
    create_dimension_assessment,
    update_dimension_assessment,
};

/// Create assessment routes
pub fn create_assessment_routes() -> Router<DatabaseConnection> {
    Router::new()
        ...
        .route("/:id/dimension-assessments", post(create_dimension_assessment))
        .route("/:id/dimension-assessments/:dimension_assessment_id", put(update_dimension_assessment))
}
